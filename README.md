...
This project contains multiple independent business subsystems, all developed with standalone static HTML files.
Unified file naming rules, convenient for Github management, static deployment, independent access routing.

## 📁 Full Subsystem List
| Chinese Name | HTML File Name | Abbreviation | Github Access URL |
| ---- | ---- | ---- | ---- |
...
| 问卷项目本地环境检测系统 | QN_Local_Environment_Detection_System.html | QLEDS | https://zwx-520.github.io/xc/QN_Local_Environment_Detection_System.html |
